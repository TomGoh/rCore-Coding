...
/// 文件系统中的 iNode 结构，表示文件或目录的元信息。
///
/// 每个 iNode 对应一个磁盘块中的一个 `DiskInode` 结构，
/// 因此需要记录该物理磁盘的 DiskInode 所在的块号和块内偏移。
pub struct Inode {
    block_id: usize,
    block_offset: usize,
...
impl Inode {
    ...
    fn find_inode_id(&self, name: &str, disk_inode: &DiskInode) -> Option<u32> {
        ...
        let mut dirent = DirEntry::init_empty();
    ...
    pub fn increase_size(
        ...
        let blocks_needed = disk_inode.blocks_num_needed_for_new_size(new_size);
    ...
    pub fn touch(&self, name: &str) -> Option<Arc<Inode>> {
        ...
        get_block_cache(new_inode_block_id as usize, Arc::clone(&fs.block_device))
            .lock()
    ...
    pub fn clear(&self) {
        ...
        self.modify_disk_inode(|disk_inode| {
            ...
            for block_id in data_block_dealloc {
